...
const RankBlock = ({ time, rank }: { time: string; rank: number | null | undefined }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-2 bg-crust border border-surface0 rounded-sm">
            ...
            <span className={`font-mono font-bold ${isRanked ? "text-lavender text-sm sm:text-text" : "text-overlay0 text-xs sm:text-sm"}`}>
