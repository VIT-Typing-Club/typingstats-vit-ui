...
export default function HomePage() {
    ...
    return (
        <div className="flex flex-col lg:grid lg:grid-cols-12 h-full overflow-y-auto lg:overflow-hidden">
            ...
            <div className="lg:col-span-4 flex flex-col min-h-[500px] lg:min-h-0 lg:h-full border-b lg:border-b-0 lg:border-r border-strong">
            ...
            <div className="lg:col-span-8 flex flex-col min-h-[600px] lg:min-h-0 lg:h-full">
                <div className="flex-1 min-h-0 flex flex-col overflow-y-auto custom-scrollbar">
